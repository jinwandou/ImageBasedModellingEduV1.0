...
public:
    ...
    math::Vec2d projection(math::Vec3d const & p3d){
        ...
        double yc = 0.0;
        double zc = 0.0;
        xc = R_[0]*p3d[0]+R_[1]*p3d[1]+R_[2]*p3d[2]+t_[0];
        yc = R_[3]*p3d[0]+R_[4]*p3d[1]+R_[5]*p3d[2]+t_[1];
        zc = R_[6]*p3d[0]+R_[7]*p3d[1]+R_[8]*p3d[2]+t_[2];
...
//        p[0] = 0.0;
//        p[1] = 0.0;
        p[0] = distort_ratio*x+c_[0];
        p[1] = distort_ratio*y+c_[1];
        return p;
    }
